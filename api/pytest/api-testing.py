...
# Define fixtures for static test_settings used by tests.
# This test_settings can be accessed by all tests in the suite unless specified otherwise.
# This could be test_settings as well as helpers of modules which will be passed to all tests.
